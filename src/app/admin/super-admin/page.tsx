...
function SuperAdminApplicationsTab() {
  ...
  return <div className="space-y-5">
    <div className="flex flex-col gap-4 rounded-xl border border-[#005FD9]/10 bg-[#F8FAFF] p-5 md:flex-row md:items-end md:justify-between">
      ...
      <div className="flex w-full gap-2 md:w-auto"><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search applicants..." className="min-w-0 flex-1 rounded-lg border border-[#005FD9]/15 bg-white px-3 py-2 text-sm text-[#134687] outline-none focus:border-[#044FAF] focus:ring-2 focus:ring-[#044FAF]/10 md:w-72" /><button onClick={() => void loadApplications()} className="rounded-lg bg-[#134687] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#044FAF]">Refresh</button></div>
    </div>
