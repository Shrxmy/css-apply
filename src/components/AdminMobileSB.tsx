...
const MobileSidebar = ({ children }: MobileSidebarProps) => {
  ...
  return (
    <>
      ...
      {/* SIDEBAR */}
      <div
        className={`fixed md:sticky md:top-0 md:self-start top-0 left-0 h-screen md:h-screen w-64 shadow-lg transition-transform duration-300 z-40 overflow-hidden
